...
CSV_PATH = os.path.join(
    OUTPUT_DIR,
    "adaptive_beta_max_10000.csv"
)
JSON_PATH = os.path.join(
    OUTPUT_DIR,
    "adaptive_beta_max_10000.json"
)
BETA_MAX_VALUES = [0.5, 1.0, 1.5, 2.0]
...
def main():
    ...
    print("=" * 70)
    print("Adaptive-MAB Beta Max Ablation")
    print("=" * 70)
    ...
    print("\n" + "=" * 70)
    print("BETA MAX ABLATION")
    print("=" * 70)
    summary_rows = []
    for beta_max in BETA_MAX_VALUES:
        row = summary[str(beta_max)]
        summary_rows.append({
            "beta_max": beta_max,
